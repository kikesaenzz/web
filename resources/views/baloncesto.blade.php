...
<body>
    ...
    <section class="columns-container">
        <div class="columnas-deportes">
            ...
            <a href="{{ route('horario', ['pabellon' => 'Pabellón Alberto Maestro']) }}">Ver Horario Semanal</a>
            <img src="img/pabellonAlbertoMaestro.jpg" class="imagen-pequena">
        </div>
        
        <div class="columnas-deportes">
            <h2>Pabellón Torrero</h2>
            <a href="{{ route('horario', ['pabellon' => 'Pabellón Torrero']) }}">Ver Horario Semanal</a>
    ...
    <section class="columns-container">
        <div class="columnas-deportes">
            ...
            <a href="{{ route('horario', ['pabellon' => 'Pabellón Arrabal']) }}">Ver Horario Semanal</a>
            <img src="img/pabellonArrabal.jpg" class="imagen-pequena">
        </div>
        
        <div class="columnas-deportes">
            <h2>Pabellón Salduba</h2>
            <a href="{{ route('horario', ['pabellon' => 'Pabellón Salduba']) }}">Ver Horario Semanal</a>
    ...
    <section class="columns-container">
        ...
        <div class="columnas-deportes">
            ...
            <a href="{{ route('horario', ['pabellon' => 'Pabellón Utebo']) }}">Ver Horario Semanal</a>
