...
<body>
    <header>
        ...
        <nav>
            <a href="/">INICIO</a>
            <a href="{{ route('reservas') }}" class="active">RESERVAS</a>
    ...
    <section>
        ...
        <div class="column-deportes">
            <div class="column-deporte">
                <a href="{{ route('reserva', ['reserva' => 'futbol']) }}" class="sport-link">
                    <div>
                        <p>Fútbol</p>
                        <img src="{{ asset('img/campoFutbol.jpg') }}" alt="Campos">
                    </div>
                </a>
            </div>

            <div class="column-deporte">
                <a href="{{ route('reserva', ['reserva' => 'baloncesto']) }}" class="sport-link">
                    <div class="campos-img">
                        <p>Baloncesto</p>
                        <img src="{{ asset('img/campoBaloncesto.jpg') }}" alt="Campos">
                    </div>
                </a>
            </div>

            <div class="column-deporte">
                <a href="{{ route('reserva', ['reserva' => 'padel']) }}" class="sport-link">
                    <div class="campos-img">
                        <p>Pádel</p>
                        <img src="{{ asset('img/campoPadel.jpg') }}" alt="Campos">
                    </div>
                </a>
            </div>

            <div class="column-deporte">
                <a href="{{ route('reserva', ['reserva' => 'fronton']) }}" class="sport-link">
                    <div class="campos-img">
                        <p>Frontón</p>
                        <img src="{{ asset('img/campoFronton.jpg') }}" alt="Campos">
                    </div>
                </a>
            </div>

            <div class="column-deporte">
                <a href="{{ route('reserva', ['reserva' => 'tenis']) }}" class="sport-link">
                    <div class="campos-img">
                        <p>Tenis</p>
                        <img src="{{ asset('img/campoTenis.jpg') }}" alt="Campos">
                    </div>
                </a>
            </div>

            <div class="column-deporte">
                <a href="{{ route('reserva', ['reserva' => 'piscina']) }}" class="sport-link">
                    <div class="campos-img">
                        <p>Piscina</p>
                        <img src="{{ asset('img/piscina.jpg') }}" alt="Campos">
                    </div>
                </a>
            </div>
        </div>
